...
background = pygame.image.load('assets/img/tetris1.png').convert()       
...
while game:                
    ...
    hits = pygame.sprite.spritecollide(player, all_pecas, True)
    if len(hits) != 0: #se estiver algum meteoro na lista de mateoros colididos com a nave, o jogo acaba
        self.speedy = 0
