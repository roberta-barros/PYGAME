...
PECA2_img_small = pygame.image.load('assets/img/tetris2.png').convert_alpha()
PECA2_img_small = pygame.transform.scale(PECA2_img, (PECA2_WIDTH, PECA2_HEIGHT))       #imagem do fundo

# ----- Inicia estruturas de dados
game = True
PECA2_X =37#random.randint(0, WIDTH-PECA2_WIDTH) #meteor_x = 200                                 #variável: posição x do meteoro
# y negativo significa que está acima do topo da janela. O meteoro começa fora da janela        
PECA2_y = 37 #meteor_y = -METEOR_HEIGHT                      #variável: posição y do meteoro (valores negativos significam que o meteoro está acima da janela. Vamos sortear valores de maneira que ele sempre comece o movimento de fora da janela, ou seja, o mais baixo possível é -METEOR_HEIGHT.)
...
PECA2_speedy = 0.1                                     #variável: velocidade y do meteoro (velocidades positivas em y significam que o meteoro vai se mover para baixo)
