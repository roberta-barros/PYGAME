...
background = pygame.image.load('tetris/tetris1.png').convert_alpha()                   #imagem do fundo
...
game = True
PECA2_X =random.randint(0, WIDTH-PECA2_HEIGHT) #meteor_x = 200                                 #variável: posição x do meteoro
# y negativo significa que está acima do topo da janela. O meteoro começa fora da janela        
PECA2_y = random.randint(-100, -PECA2_HEIGHT) #meteor_y = -METEOR_HEIGHT                      #variável: posição y do meteoro (valores negativos significam que o meteoro está acima da janela. Vamos sortear valores de maneira que ele sempre comece o movimento de fora da janela, ou seja, o mais baixo possível é -METEOR_HEIGHT.)
